...
-   A nota será composta por três exames (não-cumulativos) com pesos iguais.

## Escala de Notas

A conversão de notas numéricas para conceitos seguirá a seguinte escala:


\begin{center}
\begin{tabular}{c c}
\toprule
\textbf{Nota} & \textbf{Conceito} \\
\midrule
8,0 -- 10,0 & A \\
6,0 -- 7,9  & B \\
4,0 -- 5,9  & C \\
...
5.    Modelos de Resposta Qualitativa (Capítulo 17)

6.    Modelos de Dados em Painel (Capítulo 11)
