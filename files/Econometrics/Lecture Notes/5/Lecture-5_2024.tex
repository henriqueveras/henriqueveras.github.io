...
\begin{frame}{A Specification Test}
\protect\hypertarget{a-specification-test-1}{}
...
\[\begin{bmatrix} 
  ...
  \mathbf{y}_2  \\
    ...
    \end{bmatrix}+
    \begin{bmatrix}
    \mathbf{\varepsilon}_1 \\
    \mathbf{\varepsilon}_2 \\
    \end{bmatrix}\]
\end{frame}
...
\(\mathbf{\beta}_1=\mathbf{\beta}_2\) in the format
\(\mathbf{R\beta}=\mathbf{q}\), with
