...
Formally, we can write the restriction $\mathbf{\beta}_1=\mathbf{\beta}_2$ in the format $\mathbf{R\beta}=\mathbf{q}$, with $\mathbf{R}=[\mathbf{I}:-\mathbf{I}]$ and $\mathbf{q}=\mathbf{0}$.
