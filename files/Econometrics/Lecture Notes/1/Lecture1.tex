...
\hypertarget{why-econometrics}{%
\subsection{Why Econometrics?}\label{why-econometrics}}
...
\item
  It is about answering \textbf{real questions}:
  ...
  \end{itemize}
\item
  It provides a \textbf{bridge between theory and data}
\end{itemize}
\end{frame}
...
\tightlist
\item
  \textbf{1930s}: Creation of the Econometric Society\\
\item
  \textbf{1944}: Trygve Haavelmo's ``Probability Approach in
  Econometrics''\\
\item
  Econometrics as the \emph{science of testing economic theory with
  data}\\
\item
...
\hypertarget{famous-empirical-applications}{%
\subsection{Famous Empirical
Applications}\label{famous-empirical-applications}}

\begin{frame}{Famous Empirical Applications}
\begin{itemize}
\tightlist
\item
  \textbf{Labor Economics}: Minimum wage and employment

  \begin{itemize}
  \tightlist
  \item
    Card \& Krueger (1994): natural experiment in fast food
    restaurants\\
  \end{itemize}
\item
  \textbf{Education}: Returns to schooling
  ...
  \end{itemize}
\item
  \textbf{Development}: Impact of conditional cash transfers\\
\item
  \textbf{Macroeconomics}: Forecasting inflation and GDP growth
\end{itemize}
\end{frame}

\hypertarget{beyond-correlation-causality}{%
\subsection{Beyond Correlation:
Causality}\label{beyond-correlation-causality}}

\begin{frame}{Beyond Correlation: Causality}
\begin{itemize}
\tightlist
\item
  Econometrics is about more than prediction\\
\item
  Key distinction: \textbf{Correlation vs.~Causation}\\
\item
...
\hypertarget{new-frontiers}{%
\subsection{New Frontiers}\label{new-frontiers}}

\begin{frame}{New Frontiers}
\begin{itemize}
\tightlist
\item
  \textbf{Big Data} and administrative microdata\\
\item
  Integration with \textbf{Machine Learning}\\
\item
